...
<p>
  Pour pouvoir lancer Phrygibot, il suffit d'executer le fichier dynserveur.py . Puis d'aller sur l'addresse local : [localhost:8000](http://localhost:7986/) pour pouvoir arriver sur la page du Phrygibot 
</p>
